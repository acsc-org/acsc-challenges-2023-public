...
def read_use(file):
    ...
    for data in datas:
        ...
        if mode == 0:
            ...
            offsetX = int(Bytes[4], 16) + (int(Bytes[5], 16) << 8)
            offsetY = int(Bytes[6], 16) + (int(Bytes[7], 16) << 8)
            if offsetX > 32767:
                offsetX -= 65536
            if offsetY > 32767:
                offsetY -= 65536
            ...
            if Bytes[0] == "01":
                # print("[+] Left butten.", mousePositionX, mousePositionY)
